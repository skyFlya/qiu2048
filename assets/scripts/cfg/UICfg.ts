...
export const UICfg = {
    ...
    'PannelNetworkError': {
        ...
        needWait: false,
        zIndex: UIZIndexCfg.NETWORK_ERROR,
    },
    /**
     * 儲錢罐
     */
